...
console.log('Replacing section:', sectionEnd - sectionStart, 'chars');
      ...
      <div class="cv2-grid rv d2">
        ...
        <div class="cv2-col">
          ...
          <div class="cv2-card cv2-micro cv2-float1">
            ...
            <!-- App navigation bar (no browser chrome — app mobile) -->
            <div class="cv2-app-nav">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" style="width:16px;height:16px;color:#555;flex-shrink:0"><polyline points="15 18 9 12 15 6"/></svg>
              <div class="cv2-an-brand">
                <div class="cv2-an-logo">BK</div>
                <div class="cv2-an-info">
                  <span class="cv2-an-name">Burger King</span>
                  <span class="cv2-an-addr">Hamburguesas · Cuenca 3035, CABA</span>
                </div>
              </div>
              <div class="cv2-an-icons">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;color:#bbb"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;color:#bbb"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;color:#bbb"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>
              </div>
            </div>

            <!-- Branch info row -->
            <div class="cv2-branch-row">
              <div class="cv2-br-left">
                <div class="cv2-br-link">Ver los 3 beneficios</div>
              </div>
              <div class="cv2-br-dist">272.1 km</div>
            </div>

            <!-- Section header -->
            <div class="cv2-shd">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:11px;height:11px;flex-shrink:0"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>
              <span class="cv2-shd-lbl">PROMOS DEL COMERCIO</span>
              <span class="cv2-shd-sub">Disponibles para vos</span>
            </div>
          ...
          <!-- Invisible spacer = same height as share buttons in right col -->
          <div class="cv2-share-pad" aria-hidden="true"></div>
        ...
        <div class="cv2-col">
          ...
          <div class="cv2-card cv2-promoind cv2-float2">
            ...
            <!-- BBVA header (fiel a la referencia) -->
            <div class="cv2-pi-hd">
              <div class="cv2-pi-brand">
                <span class="cv2-pi-chip">BBVA</span>
                <span class="cv2-pi-bname">BANCO BBVA</span>
              </div>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" style="width:15px;height:15px;opacity:.55"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
            </div>
            ...
            <!-- Disclaimer (fiel a la referencia) -->
            <div class="cv2-pi-footer">
              <p class="cv2-pi-disclaimer">El beneficio puede tener condiciones y restricciones adicionales no listados aquí.</p>
              <a class="cv2-pi-terms">Ver todos los términos y condiciones</a>
            </div>

          </div><!-- /cv2-promoind -->

          <!-- Share buttons — debajo de la card (fiel a la referencia) -->
          <div class="cv2-share-ext">
            ...
            <button class="cv2-sbtn cv2-sb-qr" title="QR">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" style="width:18px;height:18px"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="5.5" y="5.5" width="2" height="2" fill="currentColor" stroke="none"/><rect x="16.5" y="5.5" width="2" height="2" fill="currentColor" stroke="none"/><rect x="5.5" y="16.5" width="2" height="2" fill="currentColor" stroke="none"/><line x1="14" y1="14" x2="17" y2="14"/><line x1="21" y1="14" x2="21" y2="17"/><line x1="14" y1="21" x2="17" y2="21"/><line x1="17" y1="17" x2="21" y2="17"/><line x1="17" y1="21" x2="17" y2="17"/></svg>
            </button>
          </div>
